...
This example shows a completed Ledger feature flow for a small business rule with an access boundary.
...
```text
.ledger/contracts/archive/secure-notes.md
.ledger/knowledge/secure-notes-verify.md
.ledger/state.md
.ledger/specs/secure-notes-pid.md
package.json
src/notes.js
